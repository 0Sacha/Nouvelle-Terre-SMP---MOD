...
public final class BankNetworking {
    ...
    public static final int ACTION_LOAN_REQUEST      = 0;  // emprunteur → envoie une demande de crédit au prêteur
    ...
    public static final int ACTION_LOAN_ACCEPT       = 6;  // prêteur accepte une demande → crédit créé + fonds transférés
    public static final int ACTION_LOAN_DECLINE      = 7;  // prêteur refuse OU emprunteur annule sa demande
