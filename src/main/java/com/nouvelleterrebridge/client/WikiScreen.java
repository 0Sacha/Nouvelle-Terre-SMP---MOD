    ...
    private void buildSections() {
        ...
        sections = List.of(
            ...
            new Section("Marché (/hdv)", "🏪", List.of(
                ...
                l(""),
                l("§7§lShop du Serveur ($Serveur) :"),
                l("  §f· §7Quand la production totale d'un item"),
                l("    §7atteint un seuil, il est vendu par §e$Serveur"),
            ...
            new Section("Roleplay", "🎭", List.of(
                ...
                l("§7§lConflits RP :"),
                cmd("/conflit"),
                l("  §f· §7Déclare un conflit RP contre un joueur"),
                l("    §7avec une raison (annoncé au serveur)"),
                l(""),
