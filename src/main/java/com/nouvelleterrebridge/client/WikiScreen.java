    ...
    private void buildSections() {
        ...
        sections = List.of(
            ...
            new Section("L'or — Shards ◆", "◆", List.of(
                ...
                l("  §f· §7Créer des crédits §e(/bank)"),
                l(""),
                l("§7§lSolde & historique :"),
                l("  §f· §7Voir le solde : §e/economie bourse"),
            ...
            new Section("Marché (/hdv)", "🏪", List.of(
                ...
                l(""),
                l("§7§lOnglets :"),
                l("  §f· §e Marché    §7— parcourir les annonces"),
            ...
            new Section("Banque (/bank)", "🏦", List.of(
                ...
                l(""),
                l("§7§lCrédits :"),
                l("  §f· §7Le montant est transféré dès l'acceptation"),
            ...
            new Section("Quêtes (/quetes)", "⚔", List.of(
                ...
                l(""),
                l("§7§lClassement : §fonglet 'Classements'"),
                l("§7pour voir qui progresse le plus.")
            )),
