    ...
    private void buildSections() {
        ...
        sections = List.of(
            ...
            new Section("L'or — Shards ◆", "◆", List.of(
                ...
                l(""),
                l("§7§lCoupures §8(nouveau)§7 :"),
                l("  §f· §71 ◆, 5 ◆, 10 ◆, 20 ◆, 50 ◆ et 100 ◆"),
                l("  §f· §7Le retrait te donne les plus grosses"),
                l("    §7coupures possibles — fini les 78 piles"),
                l("    §7de pièces pour 5 000 ◆"),
                l("  §f· §8Une coupure de 100 vaut exactement"),
                l("    §8cent pièces de 1, ni plus ni moins"),
                l("  §f· §7Pour faire de la monnaie : dépose,"),
                l("    §7puis retire le montant voulu"),
                l("  §f· §a Nouveau §7: §e/bank §7→ §aDéposer des"),
                l("    §aShards ◆ §7— choisis le montant et tout"),
                l("    §7rentre d'un coup. Plus besoin de faire"),
                l("    §7clic droit sur chaque pile."),
                l("    §8Le reste reste dans ton inventaire."),
                l(""),
            ...
            new Section("Marché (/hdv)", "🏪", List.of(
                ...
                l(""),
                l("§7§lAffichage en liste :"),
                l("  §f· §7Chaque article est une ligne : icône à"),
                l("    §7gauche, prix et bouton §6Acheter §7à droite"),
                l("  §f· §7Barre §6dorée §7à droite pour défiler —"),
                l("    §7à la molette ou en la faisant glisser"),
                l(""),
                l("§7§lSaisie des nombres §f(prix, quantités)§7 :"),
                l("  §f· §7Boutons §fMin §7/ §f-64 §7/ §f-32 §7/ §f-1 §7/"),
                l("    §f+1 §7/ §f+32 §7/ §f+64 §7/ §fMax"),
                l("  §f· §7Ou clique le champ et §ftape le nombre§7"),
                l("    §7au clavier — §fpavé numérique compris"),
                l("  §f· §7§fRetour arrière §7efface un chiffre,"),
                l("    §7§fSuppr §7remet à zéro"),
                l(""),
            ...
            new Section("Shop du serveur", "🏛", List.of(
                ...
                l(""),
                l("§7§lSaisie des quantités :"),
                l("  §f· §7Paliers §fMin §7/ §f±1 §7/ §f±32 §7/ §f±64 §7/ §fMax"),
                l("  §f· §7Ou tape directement le nombre au"),
                l("    §7clavier — §fpavé numérique compris"),
                l(""),
            ...
            new Section("Quêtes (/quetes)", "⚔", List.of(
                ...
                l(""),
                l("§8Toutes les quêtes portent sur des objets"),
                l("§8§lvanilla§8 : aucun objet de mod n'est exigé."),
                l(""),
            ...
            new Section("Production", "⛏", List.of(
                ...
                l(""),
                l("§7Quand un item atteint son §eseuil§7, il entre"),
                l("§7au catalogue du §e/shop §7avec un"),
                l("§astock illimité§7. §7Une §anotification §7prévient"),
                l("§7tout le serveur au déblocage."),
                l(""),
                l("§7§lCe qui ne compte pas :"),
                l("  §f· §7Recasser un bloc que §fvous avez posé"),
                l("  §f· §7Décompacter un bloc (1 bloc → 9) —"),
                l("    §7ça retire même le bloc du compteur"),
                l("§8Seule la matière qui entre vraiment dans le"),
                l("§8monde compte : miner, récolter, fabriquer."),
                l(""),
                l("§7§lLire l'écran :"),
                l("  §f· §7Liseré §avert §7— l'item est en vente"),
                l("  §f· §7Liseré §crouge §7— retiré par un admin"),
                l("  §f· §7Barre de progression et pourcentage"),
                l("  §f· §7Prix unitaire et taille de lot à droite"),
                l(""),
                l("§7§lRecherche : §fchamp en haut de l'écran,"),
                l("§7par nom français ou identifiant."),
                l(""),
                l("§8Plus un item est produit, §8plus son prix"),
                l("§8baisse au §e/shop §8— jusqu'à −30%.")
            )),
